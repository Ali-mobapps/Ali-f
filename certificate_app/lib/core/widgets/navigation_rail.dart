          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _NavItem(icon: Icons.qr_code_scanner_outlined, activeIcon: Icons.qr_code_scanner, label: 'Verification', isSelected: selectedIndex == 3, onTap: () => onDestinationSelected(3)),
                _NavItem(icon: Icons.palette_outlined, activeIcon: Icons.palette, label: 'Institution Branding', isSelected: selectedIndex == 4, onTap: () => onDestinationSelected(4)),
                _NavItem(icon: Icons.settings_outlined, activeIcon: Icons.settings, label: 'System Settings', isSelected: selectedIndex == 5, onTap: () => onDestinationSelected(5)),
              ],
            ),
          ),
          const Divider(),
