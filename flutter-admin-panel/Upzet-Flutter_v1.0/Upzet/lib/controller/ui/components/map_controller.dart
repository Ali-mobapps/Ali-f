...
class MapController extends MyController {
  ...
  void onInit() {
    ...
    source = const MapShapeSource.network('http://www.json-generator.com/api/json/get/bVqXoJvfjC?indent=2', shapeDataField: 'name');
    ...
    mapSource2 = MapShapeSource.asset('assets/data/world_map.json', shapeDataField: 'name');
      ...
      children: <Widget>[
        ...
        Center(
          child: MyText.bodyMedium(
            _currentTime,
            style: Theme.of(context).textTheme.labelSmall!.copyWith(letterSpacing: 0.5, fontWeight: FontWeight.w500),
          ),
        ),
      ],
    );
