...
import 'package:upzet/controller/ui/components/base_ui/placeholders_controller.dart';
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  MyText.titleMedium("Placeholder", fontSize: 18, fontWeight: 600),
                  MyBreadcrumb(
                    children: [
  ...
  Widget placeholders() {
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Placeholders", fontWeight: 700, muted: true)),
      ...
      children: [
        ...
        MyCard(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Width", fontWeight: 700, muted: true)),
              Padding(
                padding: MySpacing.all(24),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
