import 'package:upzet/models/chart_model.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
import 'package:syncfusion_flutter_charts/charts.dart';
import 'package:upzet/controller/ui/components/chart_controller.dart';
...
class _ChartScreenState extends State<ChartScreen> with UIMixin {
  ...
  Widget _buildDashedSplineChart() {
    return MyCard(
      ...
      child: SfCartesianChart(
        ...
        legend: Legend(isVisible: true, position: LegendPosition.bottom),
        primaryXAxis: NumericAxis(majorGridLines: MajorGridLines(width: 0), interval: 1),
        primaryYAxis: NumericAxis(minimum: 16, maximum: 28, interval: 4, labelFormat: '{value}%', axisLine: AxisLine(width: 0)),
            ...
            widget: SizedBox(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    _buildLegendItem(Icons.circle, Color(0xFF74B6C2), 'Winter', fontSize, size),
                    _buildLegendItem(Icons.circle, Color(0xFF4BBD8A), 'Spring', fontSize, size),
                    _buildLegendItem(Icons.circle, Color(0xFFFFBA53), 'Summer', fontSize, size),
                    _buildLegendItem(Icons.circle, Color(0xFFC26E15), 'Autumn', fontSize, size),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildLegendItem(IconData icon, Color color, String label, double fontSize, double iconSize) {
    return Row(
      children: <Widget>[
