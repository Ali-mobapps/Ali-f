...
import 'package:upzet/helper/theme/theme_type.dart';
...
class AppTheme {
  ...
  static void initTextStyle() {
    MyTextStyle.changeFontFamily(GoogleFonts.workSans);
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(titleLarge: GoogleFonts.workSans(), bodyLarge: GoogleFonts.workSans()),

    /// Floating Action Theme
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      backgroundColor: Color(0xff0bb197),
      splashColor: Color(0xffeeeeee).withAlpha(100),
      highlightElevation: 8,
      elevation: 4,
      focusColor: Color(0xff0bb197),
      hoverColor: Color(0xff0bb197),
    ...
    tabBarTheme: TabBarThemeData(
      ...
      labelColor: Color(0xff0bb197),
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(borderSide: BorderSide(color: Color(0xff0bb197), width: 2.0)),
    ),

    /// CheckBox theme
    checkboxTheme: CheckboxThemeData(checkColor: WidgetStateProperty.all(Color(0xffeeeeee)), fillColor: WidgetStateProperty.all(Color(0xff0bb197))),

    /// Radio theme
    radioTheme: RadioThemeData(fillColor: WidgetStateProperty.all(Color(0xff0bb197))),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff0bb197),
      inactiveTrackColor: Color(0xff0bb197).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff0bb197),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    scaffoldBackgroundColor: Color(0xff1d222e),
    canvasColor: Colors.transparent,
    ...
    /// Card Theme
    cardTheme: CardThemeData(color: Color(0xff252b3b)),
    ...
    inputDecorationTheme: InputDecorationTheme(
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Color(0xff0bb197)),
      ),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff0bb197),
      inactiveTrackColor: Color(0xff0bb197).withAlpha(100),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff0bb197),
      thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),
