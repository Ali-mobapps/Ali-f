/**
 * Theme: Upzet - Responsive Bootstrap 5 Admin Dashboard
 * Author: Themesdesign
 * Module/App: Main Js
 */
  ...
  setSwitchFromConfig() {
    ...
    if (config) {
      var layoutNavSwitch = document.querySelector(
        "input[type=checkbox][name=data-layout][value=" + config.nav + "]"
      );
      ...
      var layoutModeSwitch = document.querySelector(
        "input[type=checkbox][name=data-layout-mode][value=" + config.layout.mode + "]"
      );
