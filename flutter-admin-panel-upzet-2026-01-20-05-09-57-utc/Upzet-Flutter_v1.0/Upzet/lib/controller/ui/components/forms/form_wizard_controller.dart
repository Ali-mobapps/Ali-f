...
import 'package:upzet/helper/extensions/date_time_extension.dart';
...
class FormWizardController extends MyController {
  ...
  bool showPassword = false, loading = false, checked = true, enableValidation = true;
  DateTime? selectedDateTime;

  FormWizardController() {
    step1Validator.addField('username', required: true, label: "Username", controller: TextEditingController());

    step1Validator.addField('email', required: true, label: "Email", validators: [MyEmailValidator()], controller: TextEditingController());
    ...
    step2Validator.addField('first_name', required: true, label: "First name", controller: TextEditingController());

    step2Validator.addField('last_name', required: true, label: "Last name", controller: TextEditingController());
