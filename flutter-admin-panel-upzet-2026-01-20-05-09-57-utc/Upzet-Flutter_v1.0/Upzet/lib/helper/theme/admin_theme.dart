...
class LeftBarTheme {
  ...
  LeftBarTheme({
    this.background = const Color(0xff1b2c3f),
    this.onBackground = const Color(0xffdcdcdc),
    this.labelColor = const Color(0xff879baf),
    this.activeItemColor = const Color(0xffffffff),
    this.activeItemBackground = const Color(0xff363c44),
  });
...
class TopBarTheme {
  ...
  TopBarTheme({this.background = const Color(0xffffffff), this.onBackground = const Color(0xff313a46)});

  //--------------------------------------  Left Bar Theme ----------------------------------------//

  static final TopBarTheme lightTopBarTheme = TopBarTheme();

  static final TopBarTheme darkTopBarTheme = TopBarTheme(background: const Color(0xff252b3b), onBackground: const Color(0xffdcdcdc));
}
...
class ContentTheme {
  ...
  ContentTheme({
    ...
    this.primary = const Color(0xff0bb197),
