...
import 'package:upzet/app_constant.dart';
import 'package:upzet/controller/ui/components/forms/basic_element_controller.dart';
...
class _BasicElementScreenState extends State<BasicElementScreen> with UIMixin {
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  MyText.titleMedium("Basic Element", fontSize: 18, fontWeight: 600),
                  MyBreadcrumb(
                    children: [
  ...
  Widget inputTypes() {
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Input Types", fontWeight: 600)),
          Padding(
  ...
  Widget floatingLabels() {
    return MyCard(
      ...
      child: Column(
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Floating labels", fontWeight: 700, muted: true)),
  ...
  Widget checkBoxes() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Checkboxes", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(20),
            child: Column(
              children: [
  ...
  Widget radios() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Radios", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(20),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                ...
                RadioGroup<int>(
                  ...
                  child: Wrap(
                    children: [
                      Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [Radio<int>(value: 1), MyText.bodyMedium('Toggle this custom radio', fontWeight: 600)],
                      ),
                      MySpacing.width(20),
                      Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [Radio<int>(value: 2), MyText.bodyMedium('Or toggle this other custom radio', fontWeight: 600)],
                      ),
                    ],
                  ),
                ),
  ...
  Widget inputSize() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Input Size", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(20),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(hintText: '.col-sm-4', border: OutlineInputBorder()),
                ),
              ],
            ),
          ),
  ...
  Widget basicExample() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Basic Element", fontWeight: 700, muted: true)),
  ...
  Widget horizontalForm() {
    Widget buildTextField(String label, TextEditingController controller, bool obscureText) {
      return Row(
        children: [
          Expanded(
            flex: 3,
            child: Padding(padding: MySpacing.right(16.0), child: MyText.bodyMedium(label, muted: true, fontWeight: 600)),
          ),
          Expanded(
            flex: 9,
            child: TextField(
    ...
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Horizontal Form", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(20),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget inlineForm() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Inline Form", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(20),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget formRow() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Form Row", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(20),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<StateName>(
                            ...
                            items: StateName.values
                                .map(
                                  (value) =>
                                      DropdownMenuItem<StateName>(value: value, child: MyText.bodyMedium(value.name.toUpperCase(), fontWeight: 600)),
                                )
                                .toList(),
                            onChanged: (newValue) => controller.onSelectValue(newValue as String?),
                            borderRadius: BorderRadius.circular(12),
                            decoration: InputDecoration(
                              isDense: true,
                              isCollapsed: true,
