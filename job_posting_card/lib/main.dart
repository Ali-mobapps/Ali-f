              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const JobCardPage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.deepPurple,
...
class JobCardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Job Posting Card UI'),
        backgroundColor: Colors.white,
        elevation: 0,
        iconTheme: const IconThemeData(color: Colors.black87),
      ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    const CircleAvatar(
                      ...
                      child: Icon(Icons.bookmark_border_rounded, color: Colors.grey, size: 22),
                    ),
                  ],
                ),
                const SizedBox(height: 16),
                ...
                const SizedBox(height: 16),
                // Job Attributes Badges (Full-Time, Remote, etc.)
                Row(
                  children: [
                    Container(
                ...
                const SizedBox(height: 16),
                // Footer: Salary & Apply Now Button
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Column(
