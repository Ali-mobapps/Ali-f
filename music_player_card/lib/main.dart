              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const MusicPlayerCardPage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.deepPurple,
...
class MusicPlayerCardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Music Player Card', style: TextStyle(color: Colors.white)),
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: const [
                        Text('1:24', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: const [
                    Icon(Icons.shuffle_rounded, color: Colors.grey, size: 22),
                    SizedBox(width: 24),
                    ...
                    SizedBox(width: 24),
                    Icon(Icons.repeat_rounded, color: Colors.grey, size: 22),
                  ],
                ),
              ],
            ),
