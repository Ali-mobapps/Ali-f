          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const Text('Authenticate to unlock system diagnostics', style: TextStyle(fontSize: 15, color: Colors.white60)),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const system_metrics_card()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF00F0FF),
...
// ==================== TASK 26: System Metrics Card UI ====================
class system_metrics_card extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SYSTEM DIAGNOSTICS', style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1.5)),
                ...
                Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        Text('PROCESSOR LOAD (CPU)', style: TextStyle(fontSize: 12, color: Colors.white54, letterSpacing: 0.5)),
                        Text('78.4%', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF00F0FF))),
                      ],
                    ),
                    const SizedBox(height: 8),
                    ClipRRect(
                ...
                Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        Text('QUANTUM RAM ALLOCATION', style: TextStyle(fontSize: 12, color: Colors.white54, letterSpacing: 0.5)),
                        Text('14.2 / 16 GB', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFFFF007F))),
                      ],
                    ),
                    const SizedBox(height: 8),
                    ClipRRect(
