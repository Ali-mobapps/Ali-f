            ...
            children: [
              ...
              ElevatedButton(
                onPressed: dataService.isLoading
                    ? null
                    : () async {
                        final error = await dataService.login(
                        ...
                        if (error != null) {
                          ...
                          debugPrint('Login success, checking user state...');
                          if (!mounted) return;
...
class AdminDashboard extends StatelessWidget {
                ...
                children: [
                  ...
                  if (!booking.isApproved)
                    IconButton(
                      ...
                      onPressed: () {
                        dataService.approveReservation(user.id, booking.date);
                        AppNotifier.showSuccess('Seat confirmed for ${user.name}!');
                      },
                    )
  ...
  Widget _buildStatGrid(DataService dataService) {
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(child: _buildStatCard('Booked Today', occupied.toString(), Icons.event_seat_rounded, AppColors.secondary)),
          ],
        ),
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: _buildStatCard('Total Members', dataService.users.length.toString(), Icons.people_alt_rounded, AppColors.warning)),
          ],
        ),
      ],
    );
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => dataService.approveStudent(user.id),
                    ),
                    IconButton(
                      icon: Icon(Icons.cancel_rounded, color: AppColors.error.withOpacity(0.5)),
                      onPressed: () {},
                    ),
                  ],
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (hasBooking && booking.isApproved) ...[
             const SizedBox(height: 8),
             Container(
               padding: const EdgeInsets.all(12),
               decoration: BoxDecoration(
               ...
               child: Row(
                 children: [
                   ...
                   Expanded(
                     child: Text(
                        'Your seat is CONFIRMED! \nSeat: Room A - Desk ${booking.userId.substring(0, 2).toUpperCase()}',
