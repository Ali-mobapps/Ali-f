  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      darkTheme: ThemeData(
        ...
        scaffoldBackgroundColor: const Color(0xFF050505), // Deep Cyberpunk Black
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF00F0FF), // Neon Cyan Accent
          secondary: const Color(0xFFFF007F), // Neon Pink Accent
          brightness: Brightness.dark,
        ),
        useMaterial3: true,
      ),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const Text('Authenticate to unlock neon pass cards', style: TextStyle(fontSize: 15, color: Colors.white60)),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const cyberpunk_event_pass()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF00F0FF),
...
// ==================== TASK 25: Cyberpunk Event Pass Card UI ====================
class cyberpunk_event_pass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('NEO EVENT PASS', style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1.5)),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: const [
                              ...
                              Text(
                                'SECTOR 04 // NEO TOKYO',
                                style: TextStyle(fontSize: 11, color: Color(0xFF00F0FF), letterSpacing: 0.5),
                              ),
                            ],
                          ),
                        ],
                ...
                // Pass Divider Dashed Effect simulation
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: const [
                              Text('HOLDER', style: TextStyle(fontSize: 11, color: Colors.white54, letterSpacing: 0.8)),
                              SizedBox(height: 4),
                              Text('ALEXANDER V.', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                            ],
                          ),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: const [
                              Text('DATE & TIME', style: TextStyle(fontSize: 11, color: Colors.white54, letterSpacing: 0.8)),
                              SizedBox(height: 4),
                              Text('NOV 24 // 22:00', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                            ],
                          ),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: List.generate(36, (index) => Container(
                            width: (index % 3 == 0) ? 4 : 2,
                            height: 30,
