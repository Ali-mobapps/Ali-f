class SubscriptionRequestModel {
  ...
  SubscriptionRequestModel({required this.subscriptionName, required this.transactionNumber, required this.note, required this.attachment, required this.userId, required this.duration, required this.approvedDate, required this.amount});
