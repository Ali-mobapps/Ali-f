              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const HotelCardPage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.deepPurple,
...
class HotelCardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Hotel Booking Card UI'),
        backgroundColor: Colors.white,
        elevation: 0,
        iconTheme: const IconThemeData(color: Colors.black87),
      ),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // Hotel Image Container with Badge & Favorite Icon
                Stack(
                  children: [
                    Container(
                      height: 180,
                    ...
                    children: [
                      ...
                      Row(
                        children: const [
                          ...
                          SizedBox(width: 4),
                          Text(
                            'Downtown, Zurich • 1.2 km from center',
                            style: TextStyle(
                              fontSize: 13,
                              color: Colors.grey,
                            ),
